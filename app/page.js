  ...
  return (
    <main className="flex flex-col justify-center items-center m-4 p-4">
      ...
      <ul className="my-4">
        ...
        <li>
          <Link href="./week-5"className={linkStyles}>Week 5</Link>
        </li>
        <li>
          <Link href="./week-6"className={linkStyles}>Week 6</Link>
        </li>
        <li>
          <Link href="./week-7"className={linkStyles}>Week 7</Link>
        </li>
        <li>
          <Link href="./week-8"className={linkStyles}>Week 8</Link>
        </li>
      </ul>
    </main>
  );
